...
// global variables, including my personal Open Weather API Key
var owAPI = "0d1f69bec795c88eae55af82115b75b6";
var currentCity = "";
var lastCity = "";
...
var getCurrentConditions = (event) => {
    ...
    // Set queryURL to fetch API using city. features imperial conversion //
    let queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=imperial" + "&APPID=" + owAPI;
    fetch(queryURL)
        .then(handleErrors)
        .then((response) => {
...
var getFiveDayForecast = (event) => {
    ...
    let queryURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + city + "&units=imperial" + "&APPID=" + owAPI;
    // Fetch from API
    fetch(queryURL)
        .then(handleErrors)
        .then((response) => {
